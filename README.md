...
This is a camera app that detects hand landmarks either from continuous camera frames seen by your device's front camera, an image, or a video from the device's gallery using a custom **task** file.
...
Downloading, extracting, and placing the models into the *assets* folder is
